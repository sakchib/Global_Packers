<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/Site.master" AutoEventWireup="true" CodeFile="photo-upload.aspx.cs" Inherits="Backend_photo_news" %>
          ...
          <div class="row">
             ...
             <div class="form-group">
                ...
                <div class="form-group"> 
                  ...
                  <label for="exampleInputEmail1"><span style="color: #FF0000">*</span>Service Type</label>

                    <asp:DropDownList ID="DropDownList1" runat="server"  class="form-control" >
                        <asp:ListItem>--select--</asp:ListItem>
                        <asp:ListItem Value="hs">Home Shifting</asp:ListItem>
                        <asp:ListItem Value="os">Office Shifting</asp:ListItem>
                        <asp:ListItem Value="ps">Packing Shifting</asp:ListItem>
                        <asp:ListItem Value="lu">Loading &amp; Unloading</asp:ListItem>
                        <asp:ListItem Value="ct">Car Transportation</asp:ListItem>
                        <asp:ListItem Value="wh">WhareHouse</asp:ListItem>
                    </asp:DropDownList>
